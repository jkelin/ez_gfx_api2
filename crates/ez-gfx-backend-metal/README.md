...
Apple Metal HAL using `objc2-metal`. It owns admitted devices, command queues, synchronization, heaps, allocator-backed textures, blit upload/readback, compiler-produced metallib libraries, and CAMetalLayer drawable presentation while borrowing host layer handles.
