...
The complete [C textured cube](../../examples/c/textured_cube/README.md) compiles its shader during the CMake build and exercises ABI v18 compute, structured buffers, indexed-indirect graphics, presentation, and snapshot readback on Win32. CI builds and links it, then runs Vulkan with SwiftShader; hosted DX12 remains compile-only.
