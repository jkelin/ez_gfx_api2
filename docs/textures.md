...
Batch counts above are unaffected by per-batch wait removal (bundling is unchanged); Metal wall times predate it and must not be compared across the change.
