...
- [DDS](../crates/ez-gfx-runtime/src/texture/dds.rs) and [raw](../crates/ez-gfx-runtime/src/texture/raw.rs) ingest supported native mip layouts. ABI 30 carries source codes 8/9. Direct ingestion validates the whole chain before payload copies.
