...
- [DDS](../crates/ez-gfx-runtime/src/texture/dds.rs) and [raw](../crates/ez-gfx-runtime/src/texture/raw.rs) ingest supported native mip layouts. ABI 39 carries source codes 8/9. Direct ingestion validates the whole chain before payload copies.
...
- The runtime still transcodes into owned CPU mip buffers before staging, not directly into mapped staging as the candidate proposed. The existing owner-thread allocation/transfer boundary is retained.
