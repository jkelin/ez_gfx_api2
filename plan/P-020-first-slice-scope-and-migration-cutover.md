...
2. Gate ABI 37 window/headless creation, frame end/abort, one-frame buffer invalidation, opaque-handle validation, Rust context destruction, and required Vulkan/DX12/Metal behavior.
