...
The portable GLFW [`C textured cube`](02_textured_cube_c/README.md) is a separate Vulkan ABI 39 flow using tagged native window handles. C owns its opaque generational frames and explicitly ends or aborts them.
